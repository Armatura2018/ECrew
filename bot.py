...
async def init_db():
    ...
    async with aiosqlite.connect(DB_PATH) as db:
        ...
        # НАШ НОВЫЙ БЛОК ДЛЯ СТОЛБЦА TITLE
        try:
